...
# pie chart for womens curling medal colours (gold, silver, bronze)
...
with open('womensChart.csv') as csvfile:
...
explode = (0.12, 0.12, 0.12)

plt.pie(sizes, explode=explode, colors=colors, autopct='%1.1f%%', shadow=True, startangle=140)
plt.axis('equal')

plt.legend(labels, loc=1)
plt.title("Medals Earned By Women In Curling")
